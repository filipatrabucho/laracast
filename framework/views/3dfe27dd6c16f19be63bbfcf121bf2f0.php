...
$message = $__bag->first($__errorArgs[0]); ?>
                  <p class="text-xs text-red-500 font-semibold"><?php echo e($message); ?></p>
              <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-6 flex items-center justify-between gap-x-6">
      ...
      <div class="flex items-center gap-x-6">
        <a href="/jobs/<?php echo e($job->id); ?>" class="text-sm font-semibold leading-6 text-gray-900 ">Cancel</a>
        <div>
...
<?php endif; ?><?php /**PATH C:\Users\atrabucho\Documents\laracast\resources\views/jobs/edit.blade.php ENDPATH**/ ?>